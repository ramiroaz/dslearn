...
@Embeddable		//a classe define atributos de outra classe 
public class EnrollmentPK implements Serializable {			//classe que define a chave primaria (composta) de Enrollment
